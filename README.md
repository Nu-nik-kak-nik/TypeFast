...
3. [🏗️ Архитектура приложения](#️-архитектура-приложения)
   - [Основные компоненты](#основные-компоненты-архитектуры)
...
8. [🔌 API примеры](#-api-примеры)
   - [📖 Получение текста для тестирования](#-получение-текста-для-тестирования)
   - [💾 Сохранение результата теста](#-сохранение-результата-теста)
   - [👤 Получение профиля пользователя](#-получение-профиля-пользователя)
9. [🧪 Тестирование](#-тестирование)
   - [⚡ Быстрый старт](#-быстрый-старт-тестирование)
